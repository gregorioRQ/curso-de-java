	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				permiso2 = false;
			}catch(java.util.InputMismatchException eb) {
				System.out.println("No se aceptan caracters sólo enteros");
				teclado.next();
				permiso2 = true;
			}
		...
		do {
			try {
				System.out
				.println("Al hacer una compra superior a 200 creditos recibirá un descuento del 15%, entonces...");
				System.out.println("cuantas unidades desea lleva?: ");
				cant = teclado.nextInt();
				permiso3 = false;
			} catch (java.util.InputMismatchException ab) {
				System.out.println("No se aceptan caracters sólo enteros");
				teclado.next();
				permiso3 = true;
			}
